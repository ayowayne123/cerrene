...
function Testimonial() {
  return (
    <section className="lg:pt-[360px] relative">
        <div className="absolute bg-cerreneLightGreen rounded-full w-[200px] h-[200px] -left-[52px] top-[243px] blur-[50px] "> </div>
        <div className="absolute bg-cerreneYellow rounded-full w-[200px] h-[200px] -left-[81px] top-[354px] blur-[90px] "> </div>
        <div className="absolute bg-cerreneLightGreen rounded-full w-[200px] h-[200px] -right-[52px] bottom-[43px] blur-[50px] "> </div>
        <div className="absolute bg-cerreneYellow rounded-full w-[200px] h-[200px] -right-[81px] bottom-[154px] blur-[90px] "> </div>
        <div className="">
       <h1 className="font-semibold leading-[130%] text-cerreneGreen lg:text-[56px] mx-auto text-center lg:w-[686px]">Happy <span className="font-semibold italic">Experiences</span> Await You With Cerrene.</h1>
       ...
       {testimonials.map((testimonial, index) => (
        <Quote
          ...
          src={testimonial.src}
          className={index % 2 === 0 ? "bg-cerreneYellow" : "bg-cerreneLightGreen"}
        />
      ))}
       </div>
        </div>
