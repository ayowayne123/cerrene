...
const Imagecard =({src, title, text})=>{
    return(
        <div className="relative   ">
           ...
           <Link href='/services' className="border border-cerreneOrange text-cerreneOrange font-satoshi px-10 py-2">Learn More</Link>
        </div>
    )
}
...
<h3 className="lg:text-[50px] xl:text-[56px] font-medium leading-[110%] ">Our Expertise</h3>
