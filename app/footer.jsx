...
<div className='z-10 absolute inset-0 w-full h-full flex  lg:px-0  px-9'>
    <div className='  lg:mr-32 lg:ml-[137px] mx-9 h-[565px] p-20 lg:backdrop-blur-[32px] backdrop-blur-lg rounded-2xl my-auto bg-gradient-to-b from-[#ffffff05] to-[#4C4D1680] w-full lg:h-[520px] flex'>
